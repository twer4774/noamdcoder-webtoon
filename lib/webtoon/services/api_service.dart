...
class ApiService {
  ...
  static Future<List<WebtoonEpisodModel>> getLatestEpisodeById(
      String id) async {
    List<WebtoonEpisodModel> episodeInstances = [];
    ...
    if (response.statusCode == 200) {
      ...
      for (var episode in episodes) {
        ...
        episodeInstances.add(WebtoonEpisodModel.fromJson(episode));
      }
